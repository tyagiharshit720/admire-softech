...
const PortfolioHero = () => {
  return (
    <section className="relative bg-gradient-to-br from-blue-300 to-purple-300 text-white py-24 px-6 text-center overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-white/10 via-transparent to-transparent" />
        <div className="relative z-10 max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl text-blue-500 font-extrabold mb-6">
